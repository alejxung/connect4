# Alex Jung
# 2021. 02. 20
# Connect 4 gaming with AI using Minimax (Alpha beta pruning)
...
def minimax(board, depth, alpha, beta, maximizingPlayer):    # https://en.wikipedia.org/wiki/Minimax#Pseudocode
